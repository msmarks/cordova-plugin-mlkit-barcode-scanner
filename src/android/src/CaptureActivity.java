...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback {
        ...
        _TorchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flashState.getValue() != null) {
                    ...
                    _TorchButton.setBackgroundResource(getResources().getIdentifier(!state ? "torch_active" : "torch_inactive", "drawable", CaptureActivity.this.getPackageName()));
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(surfaceView, getResources().getIdentifier("permission_camera_rationale", "string", getPackageName()),
                    ...
                    public void onSuccess(List<Barcode> barCodes) {
                        ...
                        if (barCodes.size() > 0) {
                            for (Barcode barcode : barCodes) {
                                //Toast.makeText(CaptureActivity.this, "FOUND: " + barcode.getDisplayValue(), Toast.LENGTH_SHORT).show();
